...
public class EntryHandler {
	...
	public static WhiterboardUpdateObject toObject(String message){
		...
		try {
			...
			if(vType.equals(Integer.class.getName()))
				entry = new WhiteboardEntry(json.getInt("value"), visibility);
			else if(vType.equals(Long.class.getName()))
				entry = new WhiteboardEntry(json.getLong("value"), visibility);
			else if(vType.equals(Double.class.getName()))
				entry = new WhiteboardEntry(json.getDouble("value"), visibility);
			else if(vType.equals(Boolean.class.getName()))
				entry = new WhiteboardEntry(json.getBoolean("value"), visibility);
			else if(vType.equals(String.class.getName()))
				entry = new WhiteboardEntry(json.getString("value"), visibility);
	...
	public static String toJson(List<String> keys, WhiteboardEntry entry) throws UnknownWhiteboardTypeException{
		...
		try {
			...
			if(entry.value instanceof String)
				...
				throw new UnknownWhiteboardTypeException(entry.value.getClass().getName()); 
